...
CHAPTER_REQUIREMENTS = (
    ...
    "use an empty quiz list []. This includes: references, bibliography, "
    "introduction, preface, foreword, conclusion, appendix, acknowledgements, "
    "index, table of contents, glossary, about the author, dedication, "
    "abstract, summary, endnotes, list of figures/tables, abbreviations, "
    "acronyms, or any other auxiliary/meta chapter\n\n"
    "Quality rules:\n"
